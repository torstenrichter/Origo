...
Abstract:
Intent handler for `TimeBookingIntentHandling`.
*/
...
public class TimeBookingIntentHandler: NSObject, TimeBookingIntentHandling {
    ...
    /// - Tag: confirm_intent
    public func confirm(intent: TimeBookingIntent, completion: @escaping (TimeBookingIntentResponse) -> Void) {
        ...
        completion(TimeBookingIntentResponse(code: .ready, userActivity: nil))
    }
    
    public func handle(intent: TimeBookingIntent, completion: @escaping (TimeBookingIntentResponse) -> Void) {
        /*
        guard let soup = intent.soup,
